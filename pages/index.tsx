...
export async function getServerSideProps() {
  ...
  const packagesResponse = await fetch('https://api.npms.io/v2/search?q=author:willholmeswastaken');
...
const Home: NextPage<{ blogPosts: Array<BlogPostViewModel>, packages: Array<PackageViewModel> }> = ({ blogPosts, packages }) => (
  <>
