...
const Nav = () => {
  ...
  return (
    <nav className='flex items-center justify-between w-full relative px-4 md:px-6 lg:px-8 border-gray-700 mx-auto pt-3 pb-8 sm:pb-10 bg-opacity-60 text-gray-100'>
